...
const IncomePopover: React.FC<IncomePopoverProps> = ({
  filterValue,
  setFilterValue,
  fromDate,
  setFromDate,
  ...
  const categoryOptions = useMemo(() => ["all", "Salary", "Freelance", "Other"], []);
  ...
  return (
    <Popover key={"income_filter"} showArrow offset={10} placement="bottom">
      <PopoverTrigger>
